...
tsconfig.setup({
    ensure_installed = {
        "lua", "vim", "vimdoc", "query", "comment", "todotxt",
        "c", "bash", "ocaml", "go", "gomod", "gowork", "scheme", "nix",

        "git_config", "git_rebase", "gitattributes", "gitcommit", "gitignore", "diff",
        "markdown", "markdown_inline", "html", "css", "json", "latex",

        "ebnf", "ini", "toml", "yaml",
        "julia", "haskell", "zig", "python", "verilog",

        "elixir", "clojure", "racket",
