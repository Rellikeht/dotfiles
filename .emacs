...
(custom-set-variables
 ...
 '(package-selected-packages
   '(slime-company undo-tree ac-slime slime dired-toggle-sudo direx dired-explorer cython-mode csproj-mode bf-mode apache-mode ztree abyss-theme python w3m elpy minibuffer-line minibuffer-complete-cycle chess vector-utils all json-mode js2-mode svg verilog-mode modus-vivendi-theme))
