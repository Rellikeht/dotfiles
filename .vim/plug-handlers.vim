...
source ~/.vim/plug-handlers/markdown.vim

source ~/.vim/plug-handlers/tmux.vim
source ~/.vim/plug-handlers/code.vim
source ~/.vim/plug-handlers/keys.vim

source ~/.vim/plug-handlers/git.vim
source ~/.vim/plug-handlers/fzf.vim
source ~/.vim/plug-handlers/history.vim
source ~/.vim/plug-handlers/repeat.vim
