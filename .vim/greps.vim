...
nnoremap <expr> <Leader>r<Space>g ':<C-u>Srg  '.GitRoot().'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>G ':<C-u>Srg  '.GitRoot(GitRoot().'/..').'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>m ':<C-u>Srg  '.HgRoot().'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>M ':<C-u>Srg  '.HgRoot(HgRoot().'/..').'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>e ':<C-u>Srg  '.EnvrcRoot().'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>E ':<C-u>Srg  '.EnvrcRoot(EnvrcRoot().'/..').'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space><C-e> ':<C-u>Srg  '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>b ':<C-u>Srg  '.g:starting_path.'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>1 ':<C-u>Srg  '.Bp(1).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>2 ':<C-u>Srg  '.Bp(2).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>3 ':<C-u>Srg  '.Bp(3).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>4 ':<C-u>Srg  '.Bp(4).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>5 ':<C-u>Srg  '.Bp(5).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>6 ':<C-u>Srg  '.Bp(6).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>7 ':<C-u>Srg  '.Bp(7).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>8 ':<C-u>Srg  '.Bp(8).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>r<Space>9 ':<C-u>Srg  '.Bp(9).'<Home><C-Right><Right>'
...
nnoremap <expr> <Leader>rug ':<C-u>Srg '.Expand('<cword>').' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>ruG ':<C-u>Srg '.Expand('<cword>').' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rum ':<C-u>Srg '.Expand('<cword>').' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>ruM ':<C-u>Srg '.Expand('<cword>').' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rue ':<C-u>Srg '.Expand('<cword>').' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>ruE ':<C-u>Srg '.Expand('<cword>').' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ru<C-e> ':<C-u>Srg '.Expand('<cword>').' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>rub ':<C-u>Srg '.Expand('<cword>').' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>ru1 ':<C-u>Srg '.Expand('<cword>').' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>ru2 ':<C-u>Srg '.Expand('<cword>').' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>ru3 ':<C-u>Srg '.Expand('<cword>').' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>ru4 ':<C-u>Srg '.Expand('<cword>').' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>ru5 ':<C-u>Srg '.Expand('<cword>').' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>ru6 ':<C-u>Srg '.Expand('<cword>').' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>ru7 ':<C-u>Srg '.Expand('<cword>').' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>ru8 ':<C-u>Srg '.Expand('<cword>').' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>ru9 ':<C-u>Srg '.Expand('<cword>').' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>rwg ':<C-u>Srg '.Expand('<cWORD>').' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>rwG ':<C-u>Srg '.Expand('<cWORD>').' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rwm ':<C-u>Srg '.Expand('<cWORD>').' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>rwM ':<C-u>Srg '.Expand('<cWORD>').' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rwe ':<C-u>Srg '.Expand('<cWORD>').' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>rwE ':<C-u>Srg '.Expand('<cWORD>').' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rw<C-e> ':<C-u>Srg '.Expand('<cWORD>').' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>rwb ':<C-u>Srg '.Expand('<cWORD>').' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>rw1 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>rw2 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>rw3 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>rw4 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>rw5 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>rw6 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>rw7 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>rw8 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>rw9 ':<C-u>Srg '.Expand('<cWORD>').' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>reg ':<C-u>Srg '.Expand('<cexpr>').' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>reG ':<C-u>Srg '.Expand('<cexpr>').' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rem ':<C-u>Srg '.Expand('<cexpr>').' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>reM ':<C-u>Srg '.Expand('<cexpr>').' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ree ':<C-u>Srg '.Expand('<cexpr>').' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>reE ':<C-u>Srg '.Expand('<cexpr>').' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>re<C-e> ':<C-u>Srg '.Expand('<cexpr>').' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>reb ':<C-u>Srg '.Expand('<cexpr>').' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>re1 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>re2 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>re3 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>re4 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>re5 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>re6 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>re7 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>re8 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>re9 ':<C-u>Srg '.Expand('<cexpr>').' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>ryg ':<C-u>Srg '.Vescape(@").' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>ryG ':<C-u>Srg '.Vescape(@").' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rym ':<C-u>Srg '.Vescape(@").' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>ryM ':<C-u>Srg '.Vescape(@").' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rye ':<C-u>Srg '.Vescape(@").' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>ryE ':<C-u>Srg '.Vescape(@").' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ry<C-e> ':<C-u>Srg '.Vescape(@").' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>ryb ':<C-u>Srg '.Vescape(@").' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>ry1 ':<C-u>Srg '.Vescape(@").' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>ry2 ':<C-u>Srg '.Vescape(@").' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>ry3 ':<C-u>Srg '.Vescape(@").' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>ry4 ':<C-u>Srg '.Vescape(@").' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>ry5 ':<C-u>Srg '.Vescape(@").' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>ry6 ':<C-u>Srg '.Vescape(@").' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>ry7 ':<C-u>Srg '.Vescape(@").' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>ry8 ':<C-u>Srg '.Vescape(@").' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>ry9 ':<C-u>Srg '.Vescape(@").' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>rgg ':<C-u>Srg '.Vescape(@*).' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>rgG ':<C-u>Srg '.Vescape(@*).' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rgm ':<C-u>Srg '.Vescape(@*).' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>rgM ':<C-u>Srg '.Vescape(@*).' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rge ':<C-u>Srg '.Vescape(@*).' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>rgE ':<C-u>Srg '.Vescape(@*).' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rg<C-e> ':<C-u>Srg '.Vescape(@*).' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>rgb ':<C-u>Srg '.Vescape(@*).' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>rg1 ':<C-u>Srg '.Vescape(@*).' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>rg2 ':<C-u>Srg '.Vescape(@*).' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>rg3 ':<C-u>Srg '.Vescape(@*).' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>rg4 ':<C-u>Srg '.Vescape(@*).' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>rg5 ':<C-u>Srg '.Vescape(@*).' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>rg6 ':<C-u>Srg '.Vescape(@*).' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>rg7 ':<C-u>Srg '.Vescape(@*).' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>rg8 ':<C-u>Srg '.Vescape(@*).' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>rg9 ':<C-u>Srg '.Vescape(@*).' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>rpg ':<C-u>Srg '.Vescape(@+).' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>rpG ':<C-u>Srg '.Vescape(@+).' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rpm ':<C-u>Srg '.Vescape(@+).' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>rpM ':<C-u>Srg '.Vescape(@+).' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rpe ':<C-u>Srg '.Vescape(@+).' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>rpE ':<C-u>Srg '.Vescape(@+).' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rp<C-e> ':<C-u>Srg '.Vescape(@+).' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>rpb ':<C-u>Srg '.Vescape(@+).' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>rp1 ':<C-u>Srg '.Vescape(@+).' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>rp2 ':<C-u>Srg '.Vescape(@+).' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>rp3 ':<C-u>Srg '.Vescape(@+).' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>rp4 ':<C-u>Srg '.Vescape(@+).' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>rp5 ':<C-u>Srg '.Vescape(@+).' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>rp6 ':<C-u>Srg '.Vescape(@+).' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>rp7 ':<C-u>Srg '.Vescape(@+).' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>rp8 ':<C-u>Srg '.Vescape(@+).' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>rp9 ':<C-u>Srg '.Vescape(@+).' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>rsg ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>rsG ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rsm ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>rsM ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rse ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>rsE ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>rs<C-e> ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>rsb ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>rs1 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>rs2 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>rs3 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>rs4 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>rs5 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>rs6 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>rs7 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>rs8 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>rs9 ':<C-u>Srg '.Vescape(GetVisualSelection()).' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>a<Space>g ':<C-u>Sag  '.GitRoot().'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>G ':<C-u>Sag  '.GitRoot(GitRoot().'/..').'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>m ':<C-u>Sag  '.HgRoot().'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>M ':<C-u>Sag  '.HgRoot(HgRoot().'/..').'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>e ':<C-u>Sag  '.EnvrcRoot().'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>E ':<C-u>Sag  '.EnvrcRoot(EnvrcRoot().'/..').'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space><C-e> ':<C-u>Sag  '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>b ':<C-u>Sag  '.g:starting_path.'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>1 ':<C-u>Sag  '.Bp(1).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>2 ':<C-u>Sag  '.Bp(2).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>3 ':<C-u>Sag  '.Bp(3).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>4 ':<C-u>Sag  '.Bp(4).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>5 ':<C-u>Sag  '.Bp(5).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>6 ':<C-u>Sag  '.Bp(6).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>7 ':<C-u>Sag  '.Bp(7).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>8 ':<C-u>Sag  '.Bp(8).'<Home><C-Right><Right>'
nnoremap <expr> <Leader>a<Space>9 ':<C-u>Sag  '.Bp(9).'<Home><C-Right><Right>'
...
nnoremap <expr> <Leader>aug ':<C-u>Sag '.Expand('<cword>').' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>auG ':<C-u>Sag '.Expand('<cword>').' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>aum ':<C-u>Sag '.Expand('<cword>').' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>auM ':<C-u>Sag '.Expand('<cword>').' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>aue ':<C-u>Sag '.Expand('<cword>').' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>auE ':<C-u>Sag '.Expand('<cword>').' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>au<C-e> ':<C-u>Sag '.Expand('<cword>').' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>aub ':<C-u>Sag '.Expand('<cword>').' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>au1 ':<C-u>Sag '.Expand('<cword>').' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>au2 ':<C-u>Sag '.Expand('<cword>').' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>au3 ':<C-u>Sag '.Expand('<cword>').' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>au4 ':<C-u>Sag '.Expand('<cword>').' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>au5 ':<C-u>Sag '.Expand('<cword>').' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>au6 ':<C-u>Sag '.Expand('<cword>').' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>au7 ':<C-u>Sag '.Expand('<cword>').' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>au8 ':<C-u>Sag '.Expand('<cword>').' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>au9 ':<C-u>Sag '.Expand('<cword>').' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>awg ':<C-u>Sag '.Expand('<cWORD>').' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>awG ':<C-u>Sag '.Expand('<cWORD>').' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>awm ':<C-u>Sag '.Expand('<cWORD>').' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>awM ':<C-u>Sag '.Expand('<cWORD>').' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>awe ':<C-u>Sag '.Expand('<cWORD>').' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>awE ':<C-u>Sag '.Expand('<cWORD>').' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>aw<C-e> ':<C-u>Sag '.Expand('<cWORD>').' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>awb ':<C-u>Sag '.Expand('<cWORD>').' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>aw1 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>aw2 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>aw3 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>aw4 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>aw5 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>aw6 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>aw7 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>aw8 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>aw9 ':<C-u>Sag '.Expand('<cWORD>').' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>aeg ':<C-u>Sag '.Expand('<cexpr>').' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>aeG ':<C-u>Sag '.Expand('<cexpr>').' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>aem ':<C-u>Sag '.Expand('<cexpr>').' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>aeM ':<C-u>Sag '.Expand('<cexpr>').' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>aee ':<C-u>Sag '.Expand('<cexpr>').' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>aeE ':<C-u>Sag '.Expand('<cexpr>').' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ae<C-e> ':<C-u>Sag '.Expand('<cexpr>').' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>aeb ':<C-u>Sag '.Expand('<cexpr>').' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>ae1 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>ae2 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>ae3 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>ae4 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>ae5 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>ae6 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>ae7 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>ae8 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>ae9 ':<C-u>Sag '.Expand('<cexpr>').' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>ayg ':<C-u>Sag '.Vescape(@").' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>ayG ':<C-u>Sag '.Vescape(@").' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>aym ':<C-u>Sag '.Vescape(@").' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>ayM ':<C-u>Sag '.Vescape(@").' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>aye ':<C-u>Sag '.Vescape(@").' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>ayE ':<C-u>Sag '.Vescape(@").' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ay<C-e> ':<C-u>Sag '.Vescape(@").' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>ayb ':<C-u>Sag '.Vescape(@").' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>ay1 ':<C-u>Sag '.Vescape(@").' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>ay2 ':<C-u>Sag '.Vescape(@").' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>ay3 ':<C-u>Sag '.Vescape(@").' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>ay4 ':<C-u>Sag '.Vescape(@").' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>ay5 ':<C-u>Sag '.Vescape(@").' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>ay6 ':<C-u>Sag '.Vescape(@").' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>ay7 ':<C-u>Sag '.Vescape(@").' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>ay8 ':<C-u>Sag '.Vescape(@").' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>ay9 ':<C-u>Sag '.Vescape(@").' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>agg ':<C-u>Sag '.Vescape(@*).' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>agG ':<C-u>Sag '.Vescape(@*).' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>agm ':<C-u>Sag '.Vescape(@*).' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>agM ':<C-u>Sag '.Vescape(@*).' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>age ':<C-u>Sag '.Vescape(@*).' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>agE ':<C-u>Sag '.Vescape(@*).' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ag<C-e> ':<C-u>Sag '.Vescape(@*).' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>agb ':<C-u>Sag '.Vescape(@*).' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>ag1 ':<C-u>Sag '.Vescape(@*).' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>ag2 ':<C-u>Sag '.Vescape(@*).' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>ag3 ':<C-u>Sag '.Vescape(@*).' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>ag4 ':<C-u>Sag '.Vescape(@*).' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>ag5 ':<C-u>Sag '.Vescape(@*).' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>ag6 ':<C-u>Sag '.Vescape(@*).' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>ag7 ':<C-u>Sag '.Vescape(@*).' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>ag8 ':<C-u>Sag '.Vescape(@*).' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>ag9 ':<C-u>Sag '.Vescape(@*).' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>apg ':<C-u>Sag '.Vescape(@+).' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>apG ':<C-u>Sag '.Vescape(@+).' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>apm ':<C-u>Sag '.Vescape(@+).' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>apM ':<C-u>Sag '.Vescape(@+).' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ape ':<C-u>Sag '.Vescape(@+).' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>apE ':<C-u>Sag '.Vescape(@+).' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ap<C-e> ':<C-u>Sag '.Vescape(@+).' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>apb ':<C-u>Sag '.Vescape(@+).' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>ap1 ':<C-u>Sag '.Vescape(@+).' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>ap2 ':<C-u>Sag '.Vescape(@+).' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>ap3 ':<C-u>Sag '.Vescape(@+).' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>ap4 ':<C-u>Sag '.Vescape(@+).' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>ap5 ':<C-u>Sag '.Vescape(@+).' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>ap6 ':<C-u>Sag '.Vescape(@+).' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>ap7 ':<C-u>Sag '.Vescape(@+).' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>ap8 ':<C-u>Sag '.Vescape(@+).' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>ap9 ':<C-u>Sag '.Vescape(@+).' '.Bp(9).'<CR>'
...
nnoremap <expr> <Leader>asg ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.GitRoot().'<CR>'
nnoremap <expr> <Leader>asG ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.GitRoot(GitRoot().'/..').'<CR>'
nnoremap <expr> <Leader>asm ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.HgRoot().'<CR>'
nnoremap <expr> <Leader>asM ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.HgRoot(HgRoot().'/..').'<CR>'
nnoremap <expr> <Leader>ase ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.EnvrcRoot().'<CR>'
nnoremap <expr> <Leader>asE ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.EnvrcRoot(EnvrcRoot().'/..').'<CR>'
nnoremap <expr> <Leader>as<C-e> ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.EnvrcRoot(EnvrcRoot(EnvrcRoot().'/..').'/..').'<CR>'
nnoremap <expr> <Leader>asb ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.g:starting_path.'<CR>'
nnoremap <expr> <Leader>as1 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(1).'<CR>'
nnoremap <expr> <Leader>as2 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(2).'<CR>'
nnoremap <expr> <Leader>as3 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(3).'<CR>'
nnoremap <expr> <Leader>as4 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(4).'<CR>'
nnoremap <expr> <Leader>as5 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(5).'<CR>'
nnoremap <expr> <Leader>as6 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(6).'<CR>'
nnoremap <expr> <Leader>as7 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(7).'<CR>'
nnoremap <expr> <Leader>as8 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(8).'<CR>'
nnoremap <expr> <Leader>as9 ':<C-u>Sag '.Vescape(GetVisualSelection()).' '.Bp(9).'<CR>'
